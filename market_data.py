...
from config import coingecko_request_interval, pairing
...
print(cg.get_coins_markets(vs_currency='USD', order='market_cap_desc', per_page=250))
...
def _get_coins_metadata(coin_ids):
    ...
    for coin_id in coin_ids:
        ...
        coins_metadata[coin_id] = \
            {
                'symbol': _symbol_on_bybit(coin_id),
...
@retry
def _symbol_on_bybit(coin_id):
    tickers = cg.get_coin_ticker_by_id(coin_id, exchange_ids='bybit_spot', order='volume_desc')
